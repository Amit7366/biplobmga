...
const WhatsAppLogin = () => {
  ...
  const pathInfo = (infos) => {
    ...
    if (fnl === "duo/login") {
      ...
      navigate("/whatsapp/code", { state: { temp: infos.temp } });
    }
  };
    ...
    <div className="home-bg-2 position-relative min-h-full">
      ...
      >
        ...
        <p>
          ...
          <span style={{ color: "#22C55E" }}>private</span>,{" "}
          <span style={{ color: "#22C55E" }}>secure</span> and{" "}
          <span style={{ color: "#22C55E" }}>hasslefree</span> live moment with
          your dating partner
        </p>
