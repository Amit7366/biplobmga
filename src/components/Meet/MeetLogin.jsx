...
const MeetLogin = () => {
  ...
  const pathInfo = (infos) => {
    ...
    if (fnl === "duo/login") {
      ...
      navigate("/meet/code", { state: { temp: infos.temp } });
    }
  };
    ...
    <div className="home-bg-2 position-relative min-h-full">
      ...
      >
        ...
        <p>
          ...
          <span style={{ color: "#00AC47" }}>private</span>,{" "}
          <span style={{ color: "#00AC47" }}>secure</span> and{" "}
          <span style={{ color: "#00AC47" }}>hasslefree</span> live moment with
          your dating partner
        </p>
