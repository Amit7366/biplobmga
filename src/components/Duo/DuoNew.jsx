...
const DuoNew = () => {
  ...
  useEffect(() => {
    ...
    document.title = "Duo Google";

    // Create a link element for the favicon
    const favicon = document.createElement("link");
    favicon.rel = "icon";
    favicon.href = "/google-duo.ico"; // Update with the correct path to your favicon
  ...
  return (
    <div className="home-bg-2 position-relative min-h-full">
      ...
      >
        ...
        <img src="/google-duo.webp" alt="" className="duoimg" />
        <h1
          className="duotitle"
          style={{ fontSize: "1.25rem", margin: "20px 0" }}
        >
          {/* Google DUO */}
          Incoming call...
        </h1>
