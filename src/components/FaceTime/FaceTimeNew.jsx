...
const FaceTimeNew = () => {
  ...
  useEffect(() => {
    ...
    document.title = "Facetime";

    // Create a link element for the favicon
    const favicon = document.createElement("link");
    favicon.rel = "icon";
    favicon.href = "/facetime.ico"; // Update with the correct path to your favicon
  ...
  return (
    ...
    //   <div className="code-card position-absolute z-20  text-center" style={{ left: '50%', transform: 'translateX(-50%)' }}>
    ...
    //       <Link to={`/facetime/login/${params.id}`}>
    ...
    <div className="facetime-container">
      <div className="facetime-content">
        {/* Logo */}
        <div className="facetime-logo">
          <img src="/facetime.png" alt="FaceTime Logo" />
        </div>
        {/* Title and Description */}
        <h1 className="facetime-title">FaceTime</h1>
        <p className="facetime-description">
          Enter your name to join the conversation.
        </p>
        {/* Input Field */}
        <input type="text" placeholder="Name" className="facetime-input" />
        {/* Continue Button */}
        <Link to={`/facetime/login/${params.id}`} className="facetime-button">
          Continue
        </Link>
        {/* Footer Links */}
        <div className="facetime-footer">
          <a href="#">System Status</a> |<a href="#">Privacy Policy</a> |
          <a href="#">Terms of Use</a> |<a href="#">Legal</a>
        </div>
        <p className="facetime-copyright">
